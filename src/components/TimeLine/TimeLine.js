...
const Timeline = () => {
  ...
  return (
    <Section id="about">
     ...
     Now almost 2 years in & I am finally starting to feel like a real developer that can build and contribute. Pick a Tech stack and/or mentor/course and start making things with it!
      </SectionText>
